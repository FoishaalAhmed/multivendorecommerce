    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 detail-body my-5">
                <div class="heading1 mt-2">&nbsp;&nbsp;Estore Registration</div>
                @include('includes.error')
                <form class="mt-2" method="post" action="{{ route('estore-register') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <span class="float-right"><small>Already registered? <a href="{{ route('estore-login') }}">Click Here</a></small></span>
                    </div>
