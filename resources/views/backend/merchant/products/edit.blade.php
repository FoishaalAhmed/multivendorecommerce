        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <div class="card-tools">
					<a href="{{route('merchant.products.index')}}" class="btn btn-sm bg-teal"><i class="fas fa-list-alt"></i> {{__('Products')}}</a>
            ...
            <div class="card-body">
                ...
                <form action="{{route('merchant.products.update', $product->id)}}" method="post" id="userForm" enctype="multipart/form-data">
					@csrf
					@method('PUT')
                    <div class="row">
						<div class="col-md-9">
