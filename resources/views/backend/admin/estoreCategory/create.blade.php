...
@section('title', 'New Estore Category')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('New Estore Category') }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.estore-categories.index') }}" class="btn btn-sm bg-teal"><i
                                class="fas fa-list-alt"></i> {{ __('Estore Categories') }}</a>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.estore-categories.store') }}" method="post" id="userForm"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" name="commission" class="form-control"
                                            ...
                                            value="{{ old('commission') }}" step="0.01"/>
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group">
                                    <div class="col-md-12">
										...
										<textarea name="information" class="form-control"
                                            placeholder="{{ __('Information') }}" required="" autocomplete="off" rows="3">{{ old('information') }}</textarea>
                                    </div>
                                </div>
                                <!-- /.form-group -->
								<div class="form-group">
