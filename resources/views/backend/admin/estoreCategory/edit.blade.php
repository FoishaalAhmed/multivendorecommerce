...
@section('title', 'Estore Category Update')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('Estore Category Update') }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.estore-categories.update', $category->id) }}" method="post" id="userForm"
