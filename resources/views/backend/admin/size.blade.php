            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="#" class="btn btn-sm bg-teal" data-toggle="modal" data-target="#myModal"><i class="fas fa-list-alt"></i> {{ __('New Size') }}</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.sizes.store') }}" method="POST" class="form-horizontal"
