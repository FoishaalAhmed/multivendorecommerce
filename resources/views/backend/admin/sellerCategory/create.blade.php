...
@section('title', 'New Seller Category')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('New Seller Category') }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.seller-categories.index') }}" class="btn btn-sm bg-teal"><i
                                class="fas fa-list-alt"></i> {{ __('Seller Categories') }}</a>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.seller-categories.store') }}" method="post" id="userForm"
