...
@section('title', 'New Merchant Category')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">{{ __('New Merchant Category') }}</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.merchant-categories.store') }}" method="post" id="userForm"
