    ...
    <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <form action="{{route('seller.products.store')}}" method="post" id="userForm" enctype="multipart/form-data">
					@csrf
                    <div class="row">
						<div class="col-md-9">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="number" name="price" class="form-control" placeholder="{{__('Price')}}" required="" autocomplete="off" value="{{old('price')}}" step="0.01"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="number" name="old_price" class="form-control" placeholder="{{__('Old Price')}}" autocomplete="off" value="{{old('old_price')}}" step="0.01"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="text" name="discount_percent" class="form-control" placeholder="{{__('Discount Percent')}}" autocomplete="off" value="{{old('discount_percent')}}" step="0.01"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										<div class="col-md-12">
											...
											<input type="text" name="discount" class="form-control" placeholder="{{__('Discount Amount')}}"  autocomplete="off" value="{{old('discount')}}" step="0.01"/>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
                                ...
                                <div class="col-md-12">
									<div class="form-group">
										<div class="col-md-12">
											<label>{{__('Tags')}}</label>
											<textarea type="text" name="tags" class="form-control" placeholder="{{__('Tags')}}" rows="3" autocomplete="off">{{old('tags')}}</textarea>
										</div>
									</div>
									<!-- /.form-group -->
								</div>
