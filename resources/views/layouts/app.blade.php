...
<body>
  ...
  <div class="head-bar">
    <div class="container">
      <div class="row">
        <div class="col-lg-3">
          <div class="logo text-center"><a href="{{ URL::to('/') }}"><img src="{{ asset('public/frontend/assets/images/logo1.png') }}" height="50px"
                width="100%"></a></div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 border-right-core-1">
          <div class="logo text-center"><a href="{{ URL::to('/') }}"><img src="{{ asset('public/frontend/assets/images/logo1.png') }}" height="50px" width="100%"></a></div>
          <br>
