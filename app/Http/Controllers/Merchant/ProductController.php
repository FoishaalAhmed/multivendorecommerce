...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.merchant.products.index', compact('products'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.merchant.products.create', compact('categories', 'subCategories', 'childCategories', 'brands', 'colors', 'sizes'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.merchant.products.show', compact('categories', 'subCategories', 'childCategories', 'brands', 'colors', 'sizes', 'product'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.merchant.products.edit', compact('categories', 'subCategories', 'childCategories', 'brands', 'colors', 'sizes', 'product', 'productColor', 'productSize'));
    }
